...
<head>
	...
	<script type="text/javascript">
		...
		function setData() {
			...
			$('.content-result .custom-table tbody').empty();
			...
			$('.content-result .custom-table tbody').append(html);
		}
	</script>
</head>
<body>
	...
	<button style="background:#F79D64; padding:15px; margin-left:10px;" onclick="setData();">예정이자 확인하기</button>
	<div class="content-result">
		<table class="custom-table" style="word-wrap:break-word; work-break:break-all;">
			<thead>
				<th>회차</th>
				<th>실행일</th>
				<th>기간</th>
